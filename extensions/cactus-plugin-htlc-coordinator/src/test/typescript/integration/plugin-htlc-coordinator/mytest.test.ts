 ...
 */
const firstHighNetWorthAccountAddress = "0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1";
const privateKeyFirstHighNetWorthAccount =
    "0x4f3edf983ac636a65a842ce7c78d9aa706d3b113bce9c46f30d7d21715b23b1d";
/**
 * Second account details
 */
const receiverAccountAddress = "0x390A077a2bdDF783cb61959EBb7a3155584F4E47";
const privateKeyReceiverAccount = "0x07653407765862e1ecebda46473021c527323e8aab3ff44bae305402ff3e77a6"
/**
 * Hashed key for the lock
 */
const hashLock =
  "0x3c335ba7f06a8b01d0596589f73c19069e21c81e5013b91f408165d1bf623d32";
const connectorInstanceId = uuidv4();
/**
 * web3SigningCredential for FirstHighNetworthAccount
 */
const web3SigningCredentialHighNetworthAccount: Web3SigningCredential = {
  ethAccount: firstHighNetWorthAccountAddress,
  secret: privateKeyFirstHighNetWorthAccount,
  type: Web3SigningCredentialType.PrivateKeyHex,
} as Web3SigningCredential;

/**
 * web3SigningCredential for ReceiverAccount
 */
 const web3SigningCredentialReceiverAccount: Web3SigningCredential = {
  ethAccount: receiverAccountAddress,
  secret: privateKeyReceiverAccount,
  type: Web3SigningCredentialType.PrivateKeyHex,
} as Web3SigningCredential;
...
test(testCase, async (t: Test) => {
  ...
  /**
   * This is for the firstHighNetworthAccount
   */
  t.comment("Deploys TestToken via .json file on deployContract function");
  const deployOutTokenFirstHighNetworthAccount = await connector.deployContract({
    contractName: TestTokenJSON.contractName,
    contractAbi: TestTokenJSON.abi,
    bytecode: TestTokenJSON.bytecode,
    web3SigningCredential: web3SigningCredentialHighNetworthAccount,
    keychainId,
    constructorArgs: ["100", "token", "2", "TKN"],
    gas: estimatedGas,
  });
  t.ok(deployOutTokenFirstHighNetworthAccount, "deployContract() output is truthy OK");
  t.ok(
    deployOutTokenFirstHighNetworthAccount.transactionReceipt,
    "deployContract() output.transactionReceipt is truthy OK",
  );
  t.ok(
    deployOutTokenFirstHighNetworthAccount.transactionReceipt.contractAddress,
    "deployContract() output.transactionReceipt.contractAddress is truthy OK",
  );
  const tokenAddressFirstHighNetworthAccount = deployOutTokenFirstHighNetworthAccount.transactionReceipt
    .contractAddress as string;

  /**
   * This is for the receiverAccount
   */
   t.comment("Deploys TestToken via .json file on deployContract function");
   ...
   const tokenAddress = deployOutTokenReceiverAccount.transactionReceipt
     .contractAddress as string;

   const recAcc = await besuTestLedger.createEthTestAccount();
   console.log(recAcc)
  ...
  //   contractName: TestTokenJSON.contractName,
  //   keychainId,
  //   signingCredential: web3SigningCredentialHighNetworthAccount,
  ...
  //   params: [firstHighNetWorthAccountAddress],
  // });
  ...
  //   params: [firstHighNetWorthAccountAddress, contractAddress],
  // });
  ...
  // const coordinatorResponse: InvokeContractV1Response = await pluginHTLCCoordinator.ownHTLC(ownHTLCRequest);
  // t.equal(coordinatorResponse.success, true, "coordinator response success is true");
  // // t.comment(JSON.stringify(coordinatorResponse))
  // const coordinatorResponseTransactionReceipt = JSON.parse(JSON.stringify(coordinatorResponse)).out.transactionReceipt;
  // // t.comment(JSON.stringify(JSON.parse(JSON.stringify(coordinatorResponse)).out.transactionReceipt))
  // t.ok(coordinatorResponseTransactionReceipt, "pluginHTLCCoordinator.ownHtlcV1() output.transactionReceipt is truthy OK")
  ...
  //   methodName: "getTxId",
  //   params: [
  //     firstHighNetWorthAccountAddress,
  ...
  // const coordinatorResponse2 = await pluginHTLCCoordinator.counterpartyHTLC(counterpartyHTLCRequest);
  // // t.comment(JSON.stringify(coordinatorResponse2))
  // t.equal(coordinatorResponse2.success, true, "response sucess is true");
  // t.equal(coordinatorResponse2.callOutput, "1", "the contract status is 1 - Active");
  ...
  // const coordinatorResponse3 = await pluginHTLCCoordinator.withdrawCounterparty(withdrawCounterpartyRequest);
