...
test(testCase, async (t: Test) => {
  ...
  const htclCoordinatorApiClient = new HtlcCoordinatorApi(configuration);
  ...
  const response = await htclCoordinatorApiClient.ownHtlcV1(ownHTLCRequest);
  ...
  const response2 = await htclCoordinatorApiClient.counterpartyHtlcV1(counterpartyHTLCRequest);
