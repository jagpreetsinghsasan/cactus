...
type RunTransactionRequest struct {
	...
	EndorsingParties []*string `json:"endorsingParties,omitempty"`
...
// GetEndorsingParties returns the EndorsingParties field value if set, zero value otherwise.
func (o *RunTransactionRequest) GetEndorsingParties() []*string {
	if o == nil || IsNil(o.EndorsingParties) {
		var ret []*string
		return ret
	}
	return o.EndorsingParties
}

// GetEndorsingPartiesOk returns a tuple with the EndorsingParties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunTransactionRequest) GetEndorsingPartiesOk() ([]*string, bool) {
	if o == nil || IsNil(o.EndorsingParties) {
		return nil, false
	}
	return o.EndorsingParties, true
}

// HasEndorsingParties returns a boolean if a field has been set.
func (o *RunTransactionRequest) HasEndorsingParties() bool {
	if o != nil && !IsNil(o.EndorsingParties) {
		return true
	}
...
// SetEndorsingParties gets a reference to the given []*string and assigns it to the EndorsingParties field.
func (o *RunTransactionRequest) SetEndorsingParties(v []*string) {
	o.EndorsingParties = v
}

// GetResponseType returns the ResponseType field value if set, zero value otherwise.
func (o *RunTransactionRequest) GetResponseType() string {
...
// and a boolean to check if the value has been set.
func (o *RunTransactionRequest) GetResponseTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ResponseType) {
		return nil, false
	}
...
func (o *RunTransactionRequest) SetResponseType(v string) {
	o.ResponseType = &v
}
