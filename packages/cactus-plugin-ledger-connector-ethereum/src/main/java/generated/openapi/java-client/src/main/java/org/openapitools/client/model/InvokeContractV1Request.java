...
public class InvokeContractV1Request {
  ...
  **/
  ...
  public InvokeContractV1Request nonce(String nonce) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contractName, web3SigningCredential, invocationType, methodName, params, value, gasConfig, nonce, timeoutMs, keychainId);
  }
