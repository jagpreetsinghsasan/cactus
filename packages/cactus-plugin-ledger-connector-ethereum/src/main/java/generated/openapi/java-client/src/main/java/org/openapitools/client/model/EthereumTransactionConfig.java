...
import org.openapitools.client.model.EthereumTransactionConfigFrom;
import org.openapitools.client.model.EthereumTransactionConfigTo;
...
public class EthereumTransactionConfig {
  ...
  private EthereumTransactionConfigFrom from;

  public static final String SERIALIZED_NAME_TO = "to";
  @SerializedName(SERIALIZED_NAME_TO)
  private EthereumTransactionConfigTo to;

  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private EthereumTransactionConfigFrom value;

  public static final String SERIALIZED_NAME_GAS = "gas";
  @SerializedName(SERIALIZED_NAME_GAS)
  private EthereumTransactionConfigFrom gas;

  public static final String SERIALIZED_NAME_GAS_PRICE = "gasPrice";
  @SerializedName(SERIALIZED_NAME_GAS_PRICE)
  private EthereumTransactionConfigFrom gasPrice;
  ...
  private EthereumTransactionConfigTo data;
  ...
  **/
  ...
  public EthereumTransactionConfig from(EthereumTransactionConfigFrom from) {
  ...
  **/
  ...
  public EthereumTransactionConfigFrom getFrom() {
    return from;
  }


  public void setFrom(EthereumTransactionConfigFrom from) {
    this.from = from;
  }


  public EthereumTransactionConfig to(EthereumTransactionConfigTo to) {
  ...
  **/
  ...
  public EthereumTransactionConfigTo getTo() {
    return to;
  }


  public void setTo(EthereumTransactionConfigTo to) {
    this.to = to;
  }


  public EthereumTransactionConfig value(EthereumTransactionConfigFrom value) {
  ...
  **/
  ...
  public EthereumTransactionConfigFrom getValue() {
    return value;
  }


  public void setValue(EthereumTransactionConfigFrom value) {
    this.value = value;
  }


  public EthereumTransactionConfig gas(EthereumTransactionConfigFrom gas) {
  ...
  **/
  ...
  public EthereumTransactionConfigFrom getGas() {
    return gas;
  }


  public void setGas(EthereumTransactionConfigFrom gas) {
    this.gas = gas;
  }


  public EthereumTransactionConfig gasPrice(EthereumTransactionConfigFrom gasPrice) {
  ...
  **/
  ...
  public EthereumTransactionConfigFrom getGasPrice() {
    return gasPrice;
  }


  public void setGasPrice(EthereumTransactionConfigFrom gasPrice) {
    this.gasPrice = gasPrice;
  }


  public EthereumTransactionConfig nonce(BigDecimal nonce) {
  ...
  **/
  ...
  public EthereumTransactionConfig data(EthereumTransactionConfigTo data) {
  ...
  **/
  ...
  public EthereumTransactionConfigTo getData() {
    return data;
  }


  public void setData(EthereumTransactionConfigTo data) {
    this.data = data;
  }
   ...
   * @return the EthereumTransactionConfig instance itself
   */
  public EthereumTransactionConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rawTransaction, ethereumTransactionConfig.rawTransaction) &&
        ...
        Objects.equals(this.gas, ethereumTransactionConfig.gas) &&
        Objects.equals(this.gasPrice, ethereumTransactionConfig.gasPrice) &&
        Objects.equals(this.nonce, ethereumTransactionConfig.nonce) &&
        Objects.equals(this.data, ethereumTransactionConfig.data)&&
        Objects.equals(this.additionalProperties, ethereumTransactionConfig.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("from") != null && !jsonObj.get("from").isJsonNull()) {
        EthereumTransactionConfigFrom.validateJsonObject(jsonObj.getAsJsonObject("from"));
      }
      // validate the optional field `to`
      if (jsonObj.get("to") != null && !jsonObj.get("to").isJsonNull()) {
        EthereumTransactionConfigTo.validateJsonObject(jsonObj.getAsJsonObject("to"));
      }
      // validate the optional field `value`
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        EthereumTransactionConfigFrom.validateJsonObject(jsonObj.getAsJsonObject("value"));
      }
      // validate the optional field `gas`
      if (jsonObj.get("gas") != null && !jsonObj.get("gas").isJsonNull()) {
        EthereumTransactionConfigFrom.validateJsonObject(jsonObj.getAsJsonObject("gas"));
      }
      // validate the optional field `gasPrice`
      if (jsonObj.get("gasPrice") != null && !jsonObj.get("gasPrice").isJsonNull()) {
        EthereumTransactionConfigFrom.validateJsonObject(jsonObj.getAsJsonObject("gasPrice"));
      }
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        EthereumTransactionConfigTo.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EthereumTransactionConfig>() {
           ...
           public EthereumTransactionConfig read(JsonReader in) throws IOException {
             ...
             EthereumTransactionConfig instance = thisAdapter.fromJsonTree(jsonObj);
