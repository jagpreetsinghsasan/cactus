...
const (
	Subscribe WatchBlocksV1 = "org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Subscribe"
	Next WatchBlocksV1 = "org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Next"
	Unsubscribe WatchBlocksV1 = "org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Unsubscribe"
	Error WatchBlocksV1 = "org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Error"
	Complete WatchBlocksV1 = "org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Complete"
)

// All allowed values of WatchBlocksV1 enum
var AllowedWatchBlocksV1EnumValues = []WatchBlocksV1{
	"org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Subscribe",
	"org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Next",
	"org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Unsubscribe",
	"org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Error",
	"org.hyperledger.cactus.api.async.ethereum.WatchBlocksV1.Complete",
}
