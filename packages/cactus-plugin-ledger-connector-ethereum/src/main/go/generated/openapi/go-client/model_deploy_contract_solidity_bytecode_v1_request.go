...
func (o *DeployContractSolidityBytecodeV1Request) GetGasConfig() GasTransactionConfig {
...
// and a boolean to check if the value has been set.
func (o *DeployContractSolidityBytecodeV1Request) GetGasConfigOk() (*GasTransactionConfig, bool) {
	if o == nil || isNil(o.GasConfig) {
		return nil, false
	}
...
func (o *DeployContractSolidityBytecodeV1Request) HasGasConfig() bool {
	if o != nil && !isNil(o.GasConfig) {
		return true
	}
...
func (o *DeployContractSolidityBytecodeV1Request) SetGasConfig(v GasTransactionConfig) {
	o.GasConfig = &v
}
