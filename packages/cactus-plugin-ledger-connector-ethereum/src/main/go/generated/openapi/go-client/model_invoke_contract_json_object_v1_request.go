...
func (o *InvokeContractJsonObjectV1Request) GetValue() string {
...
// and a boolean to check if the value has been set.
func (o *InvokeContractJsonObjectV1Request) GetValueOk() (*string, bool) {
	if o == nil || isNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *InvokeContractJsonObjectV1Request) SetValue(v string) {
	o.Value = &v
}

// GetGasConfig returns the GasConfig field value if set, zero value otherwise.
func (o *InvokeContractJsonObjectV1Request) GetGasConfig() GasTransactionConfig {
...
// and a boolean to check if the value has been set.
func (o *InvokeContractJsonObjectV1Request) GetGasConfigOk() (*GasTransactionConfig, bool) {
	if o == nil || isNil(o.GasConfig) {
		return nil, false
	}
...
func (o *InvokeContractJsonObjectV1Request) HasGasConfig() bool {
	if o != nil && !isNil(o.GasConfig) {
		return true
	}
...
func (o *InvokeContractJsonObjectV1Request) SetGasConfig(v GasTransactionConfig) {
	o.GasConfig = &v
}

// GetNonce returns the Nonce field value if set, zero value otherwise.
func (o *InvokeContractJsonObjectV1Request) GetNonce() string {
...
// and a boolean to check if the value has been set.
func (o *InvokeContractJsonObjectV1Request) GetNonceOk() (*string, bool) {
	if o == nil || isNil(o.Nonce) {
		return nil, false
	}
	return o.Nonce, true
...
func (o *InvokeContractJsonObjectV1Request) SetNonce(v string) {
	o.Nonce = &v
}
