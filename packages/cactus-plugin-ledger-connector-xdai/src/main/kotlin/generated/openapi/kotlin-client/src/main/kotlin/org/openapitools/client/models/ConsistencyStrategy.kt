 ...
 * @param pollIntervalMs The amount of time (in milliseconds) connector will wait before making another confiramtion request to the network in case of previous confiramtion request fails
 */
...
data class ConsistencyStrategy (
    ...
    @Json(name = "pollIntervalMs")
    val pollIntervalMs: kotlin.Int? = null
